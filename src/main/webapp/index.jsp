...
<script type="text/javascript">
    ...
    function build_page_info(result) {
        ...
        $("#page_info_area").append("当前" + page.pageNum + "页,总记" + page.pages + "页,总记" + page.total + "条记录")
    ...
    function build_page_nav(result) {
        ...
        $.each(result.extend.pageInfo.navigatepageNums, function (indsx, item) {
